...
import profilePic from "../images/sammy.jpg"; // Replace with your profile image path
...
const Dashboard = () => {
  ...
  const updateCourse = () => {
    setCourses(
      courses.map((course) =>
        course.id === editCourseId ? { ...course, name: editCourseName } : course
      )
    );
  ...
  return (
    ...
    <div className="dashboard-wrapper">
      ...
      <div className="dashboard-main">
        ...
        <h3>Interested Colleges</h3>     <div className="add-college">
          <input
            type="text"
          ...
          {colleges.map((college) =>
            editCollegeId === college.id ? (
              ...
              >
                ...
                <button onClick={() => setEditCollegeId(college.id) & setEditCollegeName(college.name) & setEditEligibility(college.eligibility)}>
                  Edit
                </button>
        ...
        <h3>Interested Courses</h3> <div className="add-course">
          <input
            type="text"
        ...
        <div className="courses-grid-dashboard">
          {courses.map((course) =>
            editCourseId === course.id ? (
              ...
              <div className="course-card-dashboard" key={course.id}>
                <h4>{course.name}</h4>
                <button onClick={() => setEditCourseId(course.id) & setEditCourseName(course.name)}>
                  Edit
                </button>
